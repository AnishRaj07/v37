...
<div className="tab-pane fade show tab-border active" id="home" role="tabpanel" aria-labelledby="home-tab" style={{margin:'10px'}}>
    ...
    <div className='partent'>
      ...
      <p style={{ paddingTop: "20px" , textAlign:"justify" , fontWeight:'bold'}}>
        ...
        <div className='Box-About-2' style={{ border: "1px solid black",marginTop:"10px", padding: "10px", height: "1350px" }}>
            <div style={{ width: '100%', height: '550px',marginTop:"10px", border: '2px solid black',padding:"10px 10px" , backgroundColor:"#F0F0F0",marginBottom:"10px" ,textAlign:'ce'}}>
...
<a href="/News5" className='text-reset text-decoration-none' style={{ fontWeight: 'bold', marginRight: '10px', marginLeft: '3px' }}>Screening of seven films of SJMC students  <img src={Gif} alt="newicon" height="8" width="27" style={{ marginRight: '5px', position:'relative'}} /></a>
            ...
            <div style={{ width: '100%', height: '750px', border: '2px solid black', padding:"10px 10px"  , backgroundColor:"#F0F0F0" }}>
