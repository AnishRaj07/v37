...
function Page11() {
  ...
  <p style={{ fontSize: '20px' }}>To anticipate the technological and scientific needs for the state and to plan and prepare to cater them.</p>
  <p style={{ fontSize: '20px' }}>To develop programs for faculty development for its own staff and for teachers and researchers of other institutions with similar objectives.</p>
  <p style={{ fontSize: '20px' }}>To collaborate with various faculties / schools of AKU to meet its objectives.</p>
  <p style={{ fontSize: '20px' }}>To collaborate with regional, national and international institutions to fulfill its visions, accomplish its missions and meet its objectives.</p>
